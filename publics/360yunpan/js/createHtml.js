(function(){
	...
	function createFilesHtml(data,id){
		...
		filesChilds.forEach(function(value){
			filesHtml += "<div class='disdiv dataSet' data-id="+ value.id +"><div class='select'></div><img src='img/file.png' alt='' /><span>"+ value.title +"</span><input class='oText' type='text' /></div>";
		})
		return filesHtml;
	}
